export default function Account() {
    return (
        <div className="w-[1080px] max-w-[90%] m-auto pt-14">
            <div className="flex justify-between border-b border-[#3f3f3f]">
                <div>
                    <div className="font-medium">Cuenta</div>
                    <div className="mt-10 mb-3 text-2xl">Elige cómo quieres aparecer y qué quieres ver en YouTube</div>
                    <div className="text-sm text-[#AAA]">Has iniciado sesión como correo@correo.com</div>
                </div>
                <div className="w-[180px] h-[180px]">
                    <svg fill="none" fillRule="evenodd" viewBox="0 0 155 155" xmlns="http://www.w3.org/2000/svg" focusable="false" aria-hidden="true" style={{ pointerEvents: "none", display: "inherit", width: "100%", height: "100%" }}>
            ...
            <div className="border-b border-[#3f3f3f]">
                <div className="pt-6 pb-2 font-medium">Tu canal de YouTube</div>
                <div className="text-xs text-[#AAA]">Esta es tu presencia pública en YouTube. Debes tener un canal para subir tus propios vídeos, comentar en otros o crear listas de reproducción.</div>

                <div className="flex py-5">
                    <div className="w-40 mr-14 text-sm font-medium">Tu canal</div>
                    <div>
                        <div className="flex items-center gap-3 pt-1 pb-5">
                            <div className="flex items-center justify-center w-[50px] h-[50px] rounded-full bg-[#303030]">
                                <i className="bi bi-person text-2xl text-[#999]"></i>
                            </div>
                            <div className="text-sm">Usuario</div>
                        </div>

                        <div className="flex flex-col">
                            <a href="#" className="pb-2 pl-1 text-sm text-[#3ea6ff] font-medium">Estado y funciones del canal</a>
                            <a href="#" className="pb-2 pl-1 text-sm text-[#3ea6ff] font-medium">Crear un canal</a>
                            <a href="#" className="pb-2 pl-1 text-sm text-[#3ea6ff] font-medium">Ver configuración avanzada</a>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div>
                <div className="pt-6 pb-2 text-xl font-medium">Tu cuenta</div>
                <div className="text-xs text-[#AAA]">Inicias sesión en YouTube con tu cuenta de Google</div>

                <div className="mt-5">
                    <div className="flex py-5 text-sm">
                        <div className="w-40 mr-14 font-medium">Cuenta de Google</div>
                        <div>
                            <a href="#" className="text-[#3ea6ff] font-medium">Ver o cambiar la configuración de tu cuenta de Google</a>
                            <div className="text-[#AAA]">Se te redirigirá a la página de tu cuenta de Google.</div>
                        </div>
                    </div>

                    <div className="flex py-5 text-sm">
                        <div className="w-40 mr-14 font-medium">Centro Familiar</div>
                        <div>
                            <a href="#" className="text-[#3ea6ff] font-medium">Gestiona perfiles infantiles y funciones para adolescentes</a>
                            <div className="text-[#AAA]">Herramientas para conectar a padres, niños y adolescentes en YouTube</div>
                        </div>
                    </div>

                    <div className="flex py-5 text-sm">
                        <div className="w-40 mr-14 font-medium">Suscripción</div>
                        <div>
                            <span className="text-white">Sin suscripción | <a href="#" className="text-[#3ea6ff] font-medium">Hazte con YouTube Premium</a></span>
                            <div className="text-[#AAA]">Disfruta de música sin interrupciones, vídeos sin anuncios y mucho más con YouTube Premium.</div>
                        </div>
                    </div>
                </div>
            </div>
