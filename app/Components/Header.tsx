        ...
        <header className="h-14">
            <div className="fixed top-0 flex items-center justify-between w-full h-14 px-4 bg-[#0f0f0f] z-50">
                ...
                <div className="flex items-center gap-3">
                    <div className="flex items-center justify-center w-10 h-10 hover:bg-[#272727] rounded-full cursor-pointer">
                    ...
                    <div className="flex justify-center w-[60px]">
                        <div className="flex items-center justify-center w-8 h-8 mx-1.5 bg-[#303030] rounded-full hover:bg-[#272727] cursor-pointer">
